...
[확정 인계·완료 판정 기준](HANDOFF.md)을 먼저 확인합니다. 새 저장소는 더 이상 빈 저장소가 아니며, 재이관·재초기화를 하지 않습니다.
...
[연결·검증 절차](CONNECT.md) · [실제 게시 상태 점검](https://github.com/kokoom94-ai/jeju-oldtown-3d/blob/jeju-before-web/precision/readiness.json) · [게시 기록](https://github.com/kokoom94-ai/jeju-oldtown-3d/blob/jeju-before-web/precision/publication.json)
