...
test('new repository address is used consistently',()=>{assert.equal(PLANNED_URL,'https://kokoom94-ai.github.io/jeju-oldtown-3d/');assert.equal(SETTINGS_URL,'https://github.com/kokoom94-ai/jeju-oldtown-3d/settings/pages');assert.equal(VERSION,'3.8.0-visitor-navigation');});
